                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">@lang('Sign in to continue to Velzon.')</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="email" name="email" @class(['form-control', 'is-invalid' => $errors->has('email')])placeholder="@lang('Enter email address')" value="{{ old('email') }}">
                                            @error('email')
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="{{ route('password.request') }}" class="text-muted">@lang('Forgot password?')</a>
                                            </div>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" @checked(old('remember'))name="remember" id="remember">
                                            <label class="form-check-label" for="remember">@lang('Remember me')</label>
                                        </div>

                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit">@lang('Sign In')</button>
                                        </div>

                                        <div class="mt-4 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="fs-13 mb-4 title">@lang('Sign In with')</h5>
                                            </div>
                                            <div>
